...
{
    /// <summary>
    /// 에디터 Inspector를 위한 헬퍼 메서드
    /// </summary>
    public static class InspectorHelper
    {
        /// <summary>
        /// 주어진 Rect에서 EditorInspector를 위한 기본 높이 Rect를 계산합니다.
        /// </summary>
        ...
        /// <summary>
        /// 주어진 Rect에서 EditorInspector를 위한 다음 줄의 Rect를 계산합니다.
        /// </summary>
        /// <param name="rect"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 검색 가능한 드롭다운 필드를 그립니다; string값을 사용합니다.
        /// </summary>
        /// <param name="rect">그릴 위치</param>
        /// <param name="property">선택된 값</param>
    ...
    public class SearchableDropdown : AdvancedDropdown
    {
        ...
        private class DropdownOptionItem : AdvancedDropdownItem
        {
            ...
            public DropdownOptionItem(DropdownOption option) : base(option.DisplayName)
            {
                Option = option;
            }
        }
